...
// let feeling = prompt("How are you felling today?").toLowerCase();
...
//         break;
//     case "sad":
//         console.log("That's too bad, I hope you fell better soon.");
//         break;
//     case "hungry":
...
let num = prompt("Please emter a whole number");
let message;
